# Ruppin Academic Center — Computer Science

My journey through the CS degree at Ruppin Academic Center.
...
```
Year 1:  C → C# → Python
Year 2:  Java · HTML/CSS/JS · SQL · Python/ML · .NET/C#
```
